...
class SlidingList {
  ...
  constructor(list) {
    ...
    (0, _defineProperty2.default)(this, "roomIndexToRoomId", void 0);
    (0, _defineProperty2.default)(this, "joinedCount", void 0);
...
class SlidingSync extends _typedEventEmitter.TypedEventEmitter {
  ...
  resend() {
    ...
    (_this$pendingReq = this.pendingReq) === null || _this$pendingReq === void 0 ? void 0 : _this$pendingReq.abort();
    return d.promise;
  }
   ...
   */
  stop() {
    var _this$pendingReq2;
    this.terminated = true;
    (_this$pendingReq2 = this.pendingReq) === null || _this$pendingReq2 === void 0 ? void 0 : _this$pendingReq2.abort();
