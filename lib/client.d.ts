...
type EmittedEvents = ClientEvent | RoomEvents | RoomStateEvents | CryptoEvents | MatrixEventEvents | RoomMemberEvents | UserEvents | CallEvent | CallEventHandlerEvent.Incoming | HttpApiEvent.SessionLoggedOut | HttpApiEvent.NoConsent | BeaconEvent;
...
export declare class MatrixClient extends TypedEventEmitter<EmittedEvents, ClientEventHandlerMap> {
    ...
    protected checkTurnServersIntervalID: ReturnType<typeof setInterval> | null;
    ...
    * @return {Object} the response, with chunk, prev_batch and, next_batch.
     ...
     */
    slidingSync(req: MSC3575SlidingSyncRequest, proxyBaseUrl?: string): IAbortablePromise<MSC3575SlidingSyncResponse>;
    /**
     * @experimental
     */
