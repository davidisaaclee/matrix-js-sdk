...
class MatrixHttpApi {
  ...
  request(callback, method, path, queryParams, data, opts) {
    var _opts$prefix, _opts$baseUrl;
    ...
    const baseUrl = (_opts$baseUrl = opts === null || opts === void 0 ? void 0 : opts.baseUrl) !== null && _opts$baseUrl !== void 0 ? _opts$baseUrl : this.opts.baseUrl;
