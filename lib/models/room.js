...
class Room extends _readReceipt.ReadReceipt {
  ...
  eventShouldLiveIn(event, events, roots) {
    var _this$client2, _this$findEventById;
    if (!((_this$client2 = this.client) !== null && _this$client2 !== void 0 && _this$client2.supportsExperimentalThreads())) {
      return {
