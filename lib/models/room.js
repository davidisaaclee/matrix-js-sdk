...
class Room extends _typedEventEmitter.TypedEventEmitter {
  ...
  eventShouldLiveIn(event, events, roots) {
    ...
    const parentEvent = (_this$findEventById = this.findEventById(parentEventId)) !== null && _this$findEventById !== void 0 ? _this$findEventById : events === null || events === void 0 ? void 0 : events.find(e => e.getId() === parentEventId);
  ...
  addLiveEvent(event, addLiveEventOptions) {
    ...
    if (event.sender && event.getType() !== _event2.EventType.RoomRedaction) {
      this.addReceipt(synthesizeReceipt(event.sender.userId, event, _read_receipts.ReceiptType.Read), true);
  ...
  getEventReadUpTo(userId, ignoreSynthesized = false) {
    var _latest2, _latest3, _ref, _ref2, _privateReadReceipt$e;
    ...
    const unstablePrivateReadReceipt = this.getReadReceiptForUserId(userId, ignoreSynthesized, _read_receipts.ReceiptType.UnstableReadPrivate);

    // If we have all, compare them
    if (publicReadReceipt !== null && publicReadReceipt !== void 0 && publicReadReceipt.eventId && privateReadReceipt !== null && privateReadReceipt !== void 0 && privateReadReceipt.eventId && unstablePrivateReadReceipt !== null && unstablePrivateReadReceipt !== void 0 && unstablePrivateReadReceipt.eventId) {
    ...
    [unstablePrivateReadReceipt, publicReadReceipt].forEach(receipt => {
      var _receipt$data, _latest, _latest$data;
      if ((receipt === null || receipt === void 0 ? void 0 : (_receipt$data = receipt.data) === null || _receipt$data === void 0 ? void 0 : _receipt$data.ts) > ((_latest = latest) === null || _latest === void 0 ? void 0 : (_latest$data = _latest.data) === null || _latest$data === void 0 ? void 0 : _latest$data.ts) || !latest) {
        latest = receipt;
      }
    });
    if ((_latest2 = latest) !== null && _latest2 !== void 0 && _latest2.eventId) return (_latest3 = latest) === null || _latest3 === void 0 ? void 0 : _latest3.eventId;

    // The more less likely it is for a read receipt to drift out of date
    // the bigger is its precedence
    return (_ref = (_ref2 = (_privateReadReceipt$e = privateReadReceipt === null || privateReadReceipt === void 0 ? void 0 : privateReadReceipt.eventId) !== null && _privateReadReceipt$e !== void 0 ? _privateReadReceipt$e : unstablePrivateReadReceipt === null || unstablePrivateReadReceipt === void 0 ? void 0 : unstablePrivateReadReceipt.eventId) !== null && _ref2 !== void 0 ? _ref2 : publicReadReceipt === null || publicReadReceipt === void 0 ? void 0 : publicReadReceipt.eventId) !== null && _ref !== void 0 ? _ref : null;
  }
