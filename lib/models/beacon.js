...
class Beacon extends _typedEventEmitter.TypedEventEmitter {
  ...
  checkLiveness() {
    ...
    const startTimestamp = ((_this$_beaconInfo4 = this._beaconInfo) === null || _this$_beaconInfo4 === void 0 ? void 0 : _this$_beaconInfo4.timestamp) > Date.now() ? ((_this$_beaconInfo5 = this._beaconInfo) === null || _this$_beaconInfo5 === void 0 ? void 0 : _this$_beaconInfo5.timestamp) - 360000 /* 6min */ : (_this$_beaconInfo6 = this._beaconInfo) === null || _this$_beaconInfo6 === void 0 ? void 0 : _this$_beaconInfo6.timestamp;
    this._isLive = !!((_this$_beaconInfo7 = this._beaconInfo) !== null && _this$_beaconInfo7 !== void 0 && _this$_beaconInfo7.live) && isTimestampInDuration(startTimestamp, (_this$_beaconInfo8 = this._beaconInfo) === null || _this$_beaconInfo8 === void 0 ? void 0 : _this$_beaconInfo8.timeout, Date.now());
