...
class MatrixCall extends _typedEventEmitter.TypedEventEmitter {
  ...
  updateRemoteSDPStreamMetadata(metadata) {
    ...
    for (const feed of this.getRemoteFeeds()) {
      ...
      feed.purpose = (_this$remoteSDPStream = this.remoteSDPStreamMetadata[streamId]) === null || _this$remoteSDPStream === void 0 ? void 0 : _this$remoteSDPStream.purpose;
    }
  }
